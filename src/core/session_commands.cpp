...
nlohmann::json SessionCommands::cmd_movelines_preview(const SessionData& session,
...
nlohmann::json SessionCommands::cmd_movelines_confirm(const SessionData& session,
                                                    const std::string& preview_id) const {
    nlohmann::json result = {
